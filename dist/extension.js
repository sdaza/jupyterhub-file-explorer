...
function activate(context) {
    ...
    const startHealthChecks = () => {
        ...
        const healthCheckIntervalMs = config.get('healthCheckInterval', 60000); // Increased to 60 seconds to reduce overhead
    ...
    const commands = [
        { id: 'jupyterFileExplorer.connectJupyter', handler: () => __awaiter(this, void 0, void 0, function* () {
                const config = vscode.workspace.getConfiguration('jupyterFileExplorer');
        ...
        { id: 'jupyterFileExplorer.addJupyterConnection', handler: () => __awaiter(this, void 0, void 0, function* () {
        ...
        { id: 'jupyterFileExplorer.selectJupyterConnection', handler: () => __awaiter(this, void 0, void 0, function* () {
                const config = vscode.workspace.getConfiguration('jupyterFileExplorer');
                const connections = config.get('connections') || [];
                if (connections.length === 0) {
        ...
        { id: 'jupyterFileExplorer.removeJupyterConnection', handler: () => __awaiter(this, void 0, void 0, function* () {
                const config = vscode.workspace.getConfiguration('jupyterFileExplorer');
                const connections = config.get('connections') || [];
                if (connections.length === 0) {
        ...
        { id: 'jupyterFileExplorer.newFile', handler: (item) => fileExplorerProvider.newFile(item) },
        { id: 'jupyterFileExplorer.newFolder', handler: (item) => fileExplorerProvider.newFolder(item) },
        ...
        { id: 'jupyterFileExplorer.uploadFile', handler: (item) => fileExplorerProvider.uploadFile(item) },
        { id: 'jupyterFileExplorer.uploadFolder', handler: (item) => fileExplorerProvider.uploadFolder(item) },
        { id: 'jupyterFileExplorer.downloadFile', handler: (item) => fileExplorerProvider.downloadFile(item) },
        { id: 'jupyterFileExplorer.renameFile', handler: (item) => fileExplorerProvider.renameFile(item) },
        { id: 'jupyterFileExplorer.deleteFile', handler: (item) => fileExplorerProvider.deleteFile(item) },
        { id: 'jupyterFileExplorer.forceDeleteFile', handler: (item) => fileExplorerProvider.forceDeleteFile(item) },
        { id: 'jupyterFileExplorer.openFile', handler: (filePath) => fileExplorerProvider.openFile(filePath) }
    ];
    // Register all commands and collect disposables
    const commandDisposables = commands.map(cmd => vscode.commands.registerCommand(cmd.id, cmd.handler));
...
class FileExplorerProvider {
    constructor() {
        ...
        this.maxCacheSize = 50; // Reduced from 100 to limit memory usage
        this.maxCacheMemory = 10 * 1024 * 1024; // 10MB max cache memory
        ...
        this._configCacheTimeout = 10000; // Cache config for 10 seconds
    ...
    updateConfigSettings() {
        ...
        this.maxCacheSize = config.get('maxCacheSize', 50);
